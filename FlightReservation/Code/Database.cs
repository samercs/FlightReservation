...
namespace FlightReservation.Code
{
    public class Database : IDisposable
    {
        ...
        public Database(string connectionstring, Providers provider)
        {
            ...
            switch (provider)
            {
                ...
                case Providers.ConfigDefined:
                    string providername = ConfigurationManager.ConnectionStrings["FlightReservation"].ProviderName;
                    switch (providername)
                    {
        ...
        public Database(Providers provider)
            : this(ConfigurationManager.ConnectionStrings["FlightReservation"].ConnectionString, provider)
        {
        }
        ...
        public Database()
            : this(ConfigurationManager.ConnectionStrings["FlightReservation"].ConnectionString, Providers.SqlServer)
        {
        }
